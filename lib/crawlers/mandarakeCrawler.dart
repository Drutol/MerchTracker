    ...
    for (var block in blocks) {
      try {
        var item = MerchItem(
            ...
            imageUrl: block.querySelector("img").attributes["src"].trim(),
        ...
        if (!item.imageUrl.endsWith("jpg") && !item.imageUrl.endsWith("png")) {
          item.imageUrl = item.imageUrl.substring(0, item.imageUrl.length - 1);
        }
